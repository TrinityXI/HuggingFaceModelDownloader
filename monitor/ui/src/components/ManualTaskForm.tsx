...
import { Search, Plus, Folder, Star, AlertCircle } from 'lucide-react'
...
export default function ManualTaskForm({ onTaskCreated }: ManualTaskFormProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {datasets.map((dataset) => (
                    <div
                      ...
                      className={`p-3 cursor-pointer hover:bg-gray-50 ${
                        selectedDataset?.id === dataset.id ? 'bg-blue-50 border-l-2 border-blue-500' : ''
                      }`}
                      onClick={() => setSelectedDataset(dataset)}
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <h3 className="text-sm font-medium text-gray-900">{dataset.id}</h3>
                          {dataset.description && (
        ...
        <div>
          ...
          <input
            ...
            placeholder="例如: datasets/bert-base-uncased"
        ...
        <div>
          <button
            type="submit"
            disabled={loading || !selectedDataset || !storagePath.trim()}
