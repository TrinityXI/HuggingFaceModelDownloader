...
class RabbitMQProducer:
    def __init__(self):
        ...
        db_path = os.getenv('SQLITE_DB_PATH', '/app/data/datasets.db')
    ...
    def handle_download_event(self, ch, method, properties, body):
        ...
        try:
            ...
            if not task:
                logger.warning(f"未找到任务: {dataset_id}")
